...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"tip-of-the-day-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "tip-of-the-day-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(TipsOfTheDayCategoriesClp.class.getName())) {
			return translateInputTipsOfTheDayCategories(oldModel);
		}

		if (oldModelClassName.equals(TipsOfTheDayUsersClp.class.getName())) {
	...
	public static Object translateInputTipsOfTheDayCategories(
		BaseModel<?> oldModel) {
		TipsOfTheDayCategoriesClp oldClpModel = (TipsOfTheDayCategoriesClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getTipsOfTheDayCategoriesRemoteModel();
	...
	public static Object translateInputTipsOfTheDayUsers(BaseModel<?> oldModel) {
		TipsOfTheDayUsersClp oldClpModel = (TipsOfTheDayUsersClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getTipsOfTheDayUsersRemoteModel();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new com.rivetlogic.NoSuchTipsOfTheDayCategoriesException();
		}

		if (className.equals("com.rivetlogic.NoSuchTipsOfTheDayUsersException")) {
	...
	public static Object translateOutputTipsOfTheDayCategories(
		BaseModel<?> oldModel) {
		TipsOfTheDayCategoriesClp newModel = new TipsOfTheDayCategoriesClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setTipsOfTheDayCategoriesRemoteModel(oldModel);

		return newModel;
	}

	public static Object translateOutputTipsOfTheDayUsers(BaseModel<?> oldModel) {
		TipsOfTheDayUsersClp newModel = new TipsOfTheDayUsersClp();
