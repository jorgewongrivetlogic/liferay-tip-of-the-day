 ...
 * @generated
 */
public class WebArticleHelperLocalServiceClp
	implements WebArticleHelperLocalService {
	public WebArticleHelperLocalServiceClp(
		...
		_methodName3 = "countJournalArticlesByCategoryIds";

		_methodParameterTypes3 = new String[] { "java.util.List" };

		_methodName4 = "getJournalArticlesByCategoryIds";
	...
	public int countJournalArticlesByCategoryIds(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName3,
					...
					new Object[] { ClpSerializer.translateInput(categoryIds) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
