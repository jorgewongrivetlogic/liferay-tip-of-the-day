...
public abstract class TipsOfTheDayUsersActionableDynamicQuery
	...
	public TipsOfTheDayUsersActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TipsOfTheDayUsersLocalServiceUtil.getService());
		setClass(TipsOfTheDayUsers.class);

		setClassLoader(com.rivetlogic.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("tipUserId");
	}
}