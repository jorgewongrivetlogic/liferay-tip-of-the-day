...
import com.rivetlogic.model.TipsOfTheDayVisitedModel;
import com.rivetlogic.model.TipsOfTheDayVisitedSoap;
...
/**
 * The base model implementation for the TipsOfTheDayVisited service. Represents a row in the &quot;rivetlogic_tod_TipsOfTheDayVisited&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.rivetlogic.model.TipsOfTheDayVisitedModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TipsOfTheDayVisitedImpl}.
 * </p>
 *
 * @author juancarrillo
 * @see TipsOfTheDayVisitedImpl
 * @see com.rivetlogic.model.TipsOfTheDayVisited
 * @see com.rivetlogic.model.TipsOfTheDayVisitedModel
 * @generated
 */
@JSON(strict = true)
public class TipsOfTheDayVisitedModelImpl extends BaseModelImpl<TipsOfTheDayVisited>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a Tips of the Day Visited model instance should use the {@link com.rivetlogic.model.TipsOfTheDayVisited} interface instead.
	 */
	public static final String TABLE_NAME = "rivetlogic_tod_TipsOfTheDayVisited";
	...
	public static final String TABLE_SQL_CREATE = "create table rivetlogic_tod_TipsOfTheDayVisited (userId LONG not null,companyId LONG not null,groupId LONG not null,tipId VARCHAR(75) not null,primary key (userId, companyId, groupId, tipId))";
	public static final String TABLE_SQL_DROP = "drop table rivetlogic_tod_TipsOfTheDayVisited";
	...
	public static final String ORDER_BY_SQL = " ORDER BY rivetlogic_tod_TipsOfTheDayVisited.userId ASC, rivetlogic_tod_TipsOfTheDayVisited.companyId ASC, rivetlogic_tod_TipsOfTheDayVisited.groupId ASC, rivetlogic_tod_TipsOfTheDayVisited.tipId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.rivetlogic.model.TipsOfTheDayVisited"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.rivetlogic.model.TipsOfTheDayVisited"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.rivetlogic.model.TipsOfTheDayVisited"),
			true);
	public static long COMPANYID_COLUMN_BITMASK = 1L;
	public static long GROUPID_COLUMN_BITMASK = 2L;
	public static long USERID_COLUMN_BITMASK = 4L;
	public static long TIPID_COLUMN_BITMASK = 8L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.rivetlogic.model.TipsOfTheDayVisited"));
	...
	private static ClassLoader _classLoader = TipsOfTheDayVisited.class.getClassLoader();
