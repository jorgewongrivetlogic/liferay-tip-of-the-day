...
<li class="control-menu-nav-item">
	<a 
		...
		data-qa-id="tipday" 
		data-target="#<%= TIPDAY_CONTROLMENU_NAMESPACE %>tipdayPanelId" 
		data-title="<%= HtmlUtil.escape(LanguageUtil.get(resourceBundle, "tipday-menuentry-message")) %>" 
		data-toggle="sidenav" 
