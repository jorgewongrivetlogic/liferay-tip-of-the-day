...
/**
 * Provides the local service interface for TipsOfTheDayVisited. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TipsOfTheDayVisitedLocalServiceUtil
...
public interface TipsOfTheDayVisitedLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TipsOfTheDayVisitedLocalServiceUtil} to access the Tips of the Day Visited local service. Add custom service methods to {@link com.rivetlogic.services.service.impl.TipsOfTheDayVisitedLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
